...
class PPO_clip():
    ...
    def learn(self,current_step,state_batch,action_batch,return_batch,old_value_batch,old_log_prob_batch,adv_batch):
        ...
        # print('state_batch:',state_batch.type(),action_batch.type(),return_batch.type(),old_value_batch.type(),old_log_prob_batch.type(),adv_batch.type())
        ...
        policy_head, value_batch,feature_vectors = self.net(state_batch)
        # print('value_batch:',value_batch)
        log_prob_batch = policy_head.log_prob(action_batch)
        # print('log_prob_batch : ',log_prob_batch.shape)
        # print('log_prob_batch : ',value_batch.type(),return_batch.type(),old_value_batch.type())
        ...
        # self.v_loss,self.v_others = self.value_loss(value_batch, return_batch)
    ...
    # critic loss (the clipped version)
